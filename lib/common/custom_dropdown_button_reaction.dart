...
// Project imports:
import 'package:react_message/common/dropdown_button_reaction.dart';
// Project imports:

class CustomDropdownButton2Reaction extends StatelessWidget {
  final String hint;
  final String? value;
  ...
  const CustomDropdownButton2Reaction({
    required this.hint,
    required this.value,
