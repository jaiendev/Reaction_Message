      ...
      child: Container(
        ...
        child: CustomPaint(
          painter: _DropdownMenuPainter(
            color: Colors.black, // Theme.of(context).canvasColor,
...
class DropdownButton2Reaction<T> extends StatefulWidget {
  ...
  ///
  /// If the [onChanged] callback is null or the list of [DropdownButton2Reaction.items]
  /// is null then the dropdown button will be disabled, i.e. its arrow will be
  /// displayed in grey and it will not respond to input. A disabled button
  /// will display the [DropdownButton2Reaction.disabledHint] widget if it is non-null.
  /// If [DropdownButton2Reaction.disabledHint] is also null but [DropdownButton2Reaction.hint] is
  /// non-null, [DropdownButton2Reaction.hint] will instead be displayed.
  /// {@endtemplate}
  ...
  @override
  State<DropdownButton2Reaction<T>> createState() =>
      _DropdownButton2ReactionState<T>();
}

class _DropdownButton2ReactionState<T> extends State<DropdownButton2Reaction<T>>
  ...
  @override
  void didUpdateWidget(DropdownButton2Reaction<T> oldWidget) {
...
/// A [FormField] that contains a [DropdownButton2Reaction].
///
/// This is a convenience widget that wraps a [DropdownButton2Reaction] widget in a
/// [FormField].
///
...
/// See also:
///
///  * [DropdownButton2Reaction], which is the underlying text field without the [Form]
///    integration.
class DropdownButtonFormField2<T> extends FormField<T> {
  /// Creates a [DropdownButton2Reaction] widget that is a [FormField], wrapped in an
  /// [InputDecorator].
  ///
              ...
              child: Builder(builder: (BuildContext context) {
                return InputDecorator(
                  ...
                  child: DropdownButtonHideUnderline(
                    child: DropdownButton2Reaction<T>(
                      items: items,
